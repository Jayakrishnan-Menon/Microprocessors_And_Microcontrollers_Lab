...
l2:     clr a                 ;Clear the Accumulator
	...
	acall serial          ;Call the code snippet used for serial UART communication to Transmit the data
...
serial: mov sbuf,a            ;Move the Character in the Accumulator to the sbuf register for transmitting
